...
import { ClipboardCheck, LogOut, User, BarChart3, LogIn, LogOut as LogOutIcon } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">SHQ Principal Tracker</h1>
                  ...
                  <DropdownMenuLabel>
                    <div className="flex flex-col space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {isAdmin ? 'Director/Management' : 'Principal'}
                      </p>
                    </div>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} SHQ Principal Tracker. All rights reserved.
            </p>
            <a
